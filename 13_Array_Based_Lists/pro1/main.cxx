...
// of 200, sorts and prints the resulting list.
//******************************************************************
#include <fstream>  // For file I/O
#include "list.hxx" // For List class
#include <iostream>
using namespace std;

int main()
{
  List temps;       // List of temperature readings
  ...
  temps.ResetList();
  outData << "Valid readings in sorted order. " << endl;
  temps.Sort();
  while (temps.HasNext())
  {
    oneTemp = temps.GetNextItem();
