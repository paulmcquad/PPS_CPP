...
void ReadValues(ifstream &inFile, GradeBook &book)
{
    ...
    while (inFile)
    {
        ...
        inFile >> book.grades[count].gpa >> book.grades[count].examScore[0] >> book.grades[count].examScore[1] >> book.grades[count].examScore[2] >> book.grades[count].examScore[3] >> letter;
